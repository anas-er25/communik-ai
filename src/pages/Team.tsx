...
const Team = () => {
  ...
  const values = [
    {
      title: "Innovation",
      description: "Nous explorons constamment de nouvelles technologies et approches pour offrir des solutions à la pointe de l'innovation."
    },
    {
      title: "Excellence",
    ...
    {
      title: "Collaboration",
      description: "Nous croyons au pouvoir du travail d'équipe, tant en interne qu'avec nos clients, pour créer des solutions vraiment adaptées."
    },
    {
      title: "Transparence",
      description: "Nous maintenons une communication ouverte et honnête à chaque étape du processus."
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-10">
              Une équipe passionnée d'experts en communication, design, technologie et intelligence artificielle.
            </p>
            <Link to="/contact">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Notre force réside dans la diversité des compétences et des parcours de notre équipe. 
              Ensemble, nous associons créativité, expertise technique et vision stratégique 
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-communikAI-purple font-medium mb-4">{member.role}</p>
                  ...
                  <div className="flex space-x-3">
                    <a href="#" className="text-gray-500 hover:text-communikAI-purple transition-colors">
                      <Linkedin size={18} />
                    </a>
                    <a href="#" className="text-gray-500 hover:text-communikAI-purple transition-colors">
                      <Twitter size={18} />
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Ces principes guident notre approche et définissent notre culture d'entreprise.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-xl font-bold mb-4 text-communikAI-purple">{value.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Nous sommes toujours à la recherche de talents passionnés pour rejoindre notre équipe et contribuer à des projets innovants.
                </p>
                <Link to="/contact">
                  <Button className="btn-primary">Postuler</Button>
                </Link>
              </div>
              <div className="bg-communikAI-purple bg-opacity-10 p-8 rounded-lg">
                <h3 className="text-xl font-bold mb-4">Pourquoi travailler chez CommunikAI ?</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <div className="bg-communikAI-purple bg-opacity-20 p-1 rounded-full mr-3 mt-1">
                      <div className="w-3 h-3 bg-communikAI-purple rounded-full"></div>
                    </div>
